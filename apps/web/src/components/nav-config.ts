...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      { href: "/attendance", label: "Attendance", icon: CalendarCheck, perm: "attendance.view", roles: ["admin", "principal", "vp_academics"] },
      { href: "/question-banks", label: "CBT", icon: MonitorPlay, perm: "results.comment", roles: ["admin", "principal", "vp_academics"] },
      { href: "/reports?view=term", label: "Term Report", icon: FileText, perm: "results.view", roles: ["admin", "principal", "vp_academics"] },
      { href: "/reports?view=session", label: "Session Report", icon: FileText, perm: "results.view", roles: ["admin", "principal", "vp_academics"] },
      { href: "/reports?view=student", label: "Student Report", icon: FileText, perm: "results.view", roles: ["admin", "principal", "vp_academics"] },
      { href: "/reports?view=early-years", label: "Early Years Report", icon: FileText, perm: "results.view", roles: ["admin", "principal", "vp_academics"] },
      { href: "/readiness", label: "Subject Performance", icon: BarChart3, perm: "results.view", roles: ["admin", "principal", "vp_academics"] },
      { href: "/reports?view=broadsheet", label: "Broadsheet", icon: PieChart, perm: "results.view", roles: ["admin", "principal", "vp_academics"] },
      { href: "/reports?view=cumulative", label: "Cumulative Broadsheet", icon: PieChart, perm: "results.view", roles: ["admin", "principal", "vp_academics"] },
      { href: "/results/comments", label: "Teacher Comments", icon: MessageSquareText, perm: "results.comment", roles: ["admin", "principal", "vp_academics"] },
      { href: "/approvals", label: "Publish Results", icon: ListChecks, perm: "results.verify", roles: ["admin", "principal", "vp_academics"] },
      { href: "/settings", label: "Result Settings", icon: SlidersHorizontal, perm: "school.manage", roles: ["admin", "principal", "vp_academics"] },
      { href: "/teachers", label: "Users", icon: UsersRound, perm: "staff.view", roles: ["admin", "principal", "vp_academics"] },
    ],
  },
  {
