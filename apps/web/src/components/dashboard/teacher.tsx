  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {[
          { label: "Score entry", desc: "Open a score grid", href: "/results/score", icon: ClipboardCheck, tone: "bg-indigo-500/10 text-indigo-600" },
          { label: "Attendance", desc: "Mark today's register", href: "/attendance", icon: CalendarCheck, tone: "bg-emerald-500/10 text-emerald-700" },
          { label: "Timetable", desc: "Weekly schedule", href: "/timetable", icon: LayoutGrid, tone: "bg-amber-500/14 text-amber-700" },
          { label: "Lesson plans", desc: "Generate with AI", href: "/lesson-plans", icon: NotebookPen, tone: "bg-rose-500/10 text-rose-700" },
        ].map((a) => (
          <Link key={a.label} href={a.href} className="stat-card group flex items-center gap-3">
            <span className={cn("flex h-10 w-10 shrink-0 items-center justify-center rounded-[10px]", a.tone)}>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <div className="stat-card">
          ...
          <p className="mt-1 text-xs text-muted-foreground">{totals.students} students</p>
        </div>
        <div className="stat-card">
