    ...
    <div className="flex min-h-screen bg-background">
      <div className="relative hidden w-1/2 overflow-hidden bg-gradient-to-br from-primary via-primary/90 to-cyan-950 lg:block">
        ...
        <div className="relative flex h-full flex-col justify-between p-12 text-primary-foreground">
          <Image src="/logo_lumo.png" alt="Lumo" width={1536} height={1024} priority className="h-11 w-auto rounded-lg object-contain object-left" />
